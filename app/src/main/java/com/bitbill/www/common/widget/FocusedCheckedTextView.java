 ...
 * </pre>
 */
public class FocusedCheckedTextView extends android.support.v7.widget.AppCompatCheckedTextView {
    ...
    public interface OnCheckedChangeListener {
         ...
         *
         * @param myFocusedCheckedTextView The CheckedTextView whose state has changed.
