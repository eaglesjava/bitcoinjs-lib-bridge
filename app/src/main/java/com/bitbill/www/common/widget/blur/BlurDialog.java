...
package com.bitbill.www.common.widget.blur;
...
public class BlurDialog extends Dialog {
    ...
    private void initBlurLayout() {
        blurImage = findViewById(R.id.iv_blur_show);
        blurAlpha = findViewById(R.id.iv_blur_alpha);
        showView = findViewById(R.id.fl_add_views);
    }
