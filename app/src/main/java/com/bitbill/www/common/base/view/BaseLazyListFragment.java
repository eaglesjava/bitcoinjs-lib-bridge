 ...
 * <pre>
 * 懒加载列表基础碎片界面
 * Created by zhuyuanbao on 2018/1/6.
 * </pre>
 */
public abstract class BaseLazyListFragment<E extends Serializable, P extends MvpPresenter> extends BaseListFragment<E, P> implements LazyFragmentControl {

    private static final String TAG = BaseLazyListFragment.class.getSimpleName();
