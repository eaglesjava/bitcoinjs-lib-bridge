...
console.log('get private key from keystore: ' + privateKey)

console.log('private to public: ' + bridge.privateToPublic(privateKey))
console.log('private to address: ' + bridge.privateToAddress(privateKey))